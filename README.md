...
- Selected markup exposes compact icon-only quick actions for editing text, stroke color, fill color, line width, dashed/solid style, arrowhead style, rectangle corner radius, duplicate, layer front, and delete.
