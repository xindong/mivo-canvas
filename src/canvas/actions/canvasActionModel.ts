...
import type { CanvasNodeType } from '../../types/mivoCanvas'
import {
  hasAnyCapability,
  hasCommonCapability,
...
// T2.2 — effect-emission helpers live in canvasActionEmitters.ts (intent/emission split;
// see that file's header). This UI-intent layer imports them to wire menu/toolbar closures.
import {
  primaryNodeId,
  duplicateAction,
  deleteAction,
