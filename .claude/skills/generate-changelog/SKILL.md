...
> 2. `node scripts/changelog/auto-changelog.mjs rewrite` — 按 `scripts/changelog/REWRITE_PROMPT.md` 把 scan 产物**口语化改写**（本闭环唯一用 LLM 的环节），写 `/tmp/mivo-changelog-rewrite.json`
